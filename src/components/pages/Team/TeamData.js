const data = {
  marketingData: [
    {
      id: 1,
      img: 'https://drive.google.com/uc?export=view&id=1db1Vg0OthNJ0j_k8xRvCGgXFz5pOYNCf',
      position: 'Marketing Head',
      name: 'Abhinav Kumar Gupta'
    },
    {
      id: 2,
      img: 'https://drive.google.com/uc?export=view&id=1imud2URtYKHCLTe8VNHCmSIPFlSKeiu2',
      position: 'Marketing Head',
      name: 'Aditya Gupta'
    },
    {
    ...
    {
      id: 6,
      img: 'https://drive.google.com/uc?export=view&id=1FcAkQlGfQ_Pe89aUqEKs3QupSTl-Hwd-',
      position: 'Marketing Head',
      name: 'Aditya Garg'
    }
  ],
